...
use codemem_engine::hooks::{extract, parse_payload};
...
fn content_hash_is_deterministic() {
    let h1 = codemem_engine::hooks::content_hash("hello world");
    let h2 = codemem_engine::hooks::content_hash("hello world");
    assert_eq!(h1, h2);
}

#[test]
fn content_hash_differs_for_different_input() {
    let h1 = codemem_engine::hooks::content_hash("hello");
    let h2 = codemem_engine::hooks::content_hash("world");
    assert_ne!(h1, h2);
}
